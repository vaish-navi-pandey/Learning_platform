...
export const sample_courses = [
  ...
  export const sample_tags = [
    { name: 'All', count: 6 }, // Total number of courses
    { name: 'Web Development', count: 3 }, // Number of web development courses
    { name: 'Programming', count: 1 }, // Number of programming courses
    { name: 'AI', count: 1 }, // Number of AI courses
    { name: 'Design', count: 1 }, // Number of design courses
    { name: 'Creative', count: 1 }, // Number of creative courses
    { name: 'Python', count: 2 }, // Number of Python-related courses
    { name: 'JavaScript', count: 2 }, // Number of JavaScript-related courses
  ];
  
  // Sample users array (updated slightly for clarity)
